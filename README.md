...
This project simulates a real-world **infrastructure security upgrade** for *OzCazual*, a fictional local clothing company. The goal was to harden the company’s environment against common cyberattacks, with a focus on **brute-force attack protection, incident response, and network defense.**
